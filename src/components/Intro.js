...
function Intro() {
  return (
    <div className="mt-36 pl-5 flex flex-col items-start w-screen tablet:w-5/6 tablet:px-24 tablet:mt-80">
      ...
      <h1
        className={`text-5xl mb-7 text-[#94a3b8] tablet:text-6xl tablet:pt-5`}
      >
        I build things for the web
      </h1>
      <p
        className={`text-l subtext w-full text-[#94a3b8] mb-3 tablet:text-2xl`}
      >
